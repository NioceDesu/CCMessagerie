...
select * from Messages where msgText = 'Un test pour l''envoi de messages';
update Messages set msgText = 'Test pour l''envoi des messages' where msgText = 'Un test pour l''envoi de messages';
/**/
